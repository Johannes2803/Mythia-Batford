...
let peli = global.image
let ye = global.image3
  let _return
  let _syntax = ''
  ...
  try {
    ...
    _return = await exec.call(conn, (...args) => {
      ...
      return /*conn.reply(m.chat, util.format(...args), m)*/
      	conn.sendMessage(m.chat, util.format(...args), 'conversation', {thumbnail: peli, contextInfo:{externalAdReply: {title: 'johannes', sourceUrl: '', body: ``, thumbnail: ye}}})
