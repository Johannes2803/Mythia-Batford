  ...
  class WAConnection extends _WAConnection {
    constructor(...args) {
     ...
     // Wa Web Version
      ...
      this.browserDescription = ["Yuzuki choco", "firefox", "3.0"];
      // Alias
